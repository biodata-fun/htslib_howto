/* 
* Script to get certain features for SNPs in a file
* COMPILATION: 
* gcc -g -I/usr/local/include/htslib/ -D__STDC_LIMIT_MACROS -L /usr/local/lib/ get_snps_feats.c -o get_snps_feats -lz -lhts
*
* USAGE:
* get_snps_feats test.vcf.gz
*/
